...
import { PROJECTS_CTA } from "@/features/projects/projects-data";
        ...
        <div className="relative min-h-[420px] overflow-hidden rounded-[28px] border border-white/10 font-iransans sm:min-h-[50vh]">
          <div className="relative z-10 flex h-full flex-col items-center justify-center gap-6 px-6 py-16 text-center sm:gap-8 sm:px-10">
            ...
            <div className="flex w-full max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:justify-center">
              <Button
                asChild
                className="h-12 cursor-pointer rounded-2xl bg-white px-8 font-semibold text-black hover:bg-white/90"
                size="lg"
              >
                <Link href={PROJECTS_CTA.primaryCta.href}>
                  {PROJECTS_CTA.primaryCta.label}
                </Link>
              </Button>
              <Button
                asChild
                ...
                variant="outline"
              >
                <Link href={PROJECTS_CTA.secondaryCta.href}>
                  {PROJECTS_CTA.secondaryCta.label}
                </Link>
              </Button>
            </div>
