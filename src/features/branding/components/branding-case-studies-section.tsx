...
const BrandingCaseStudiesSection = () => {
  return (
    <section className="container mx-auto px-4 md:px-6" id="case-studies">
      <div className="mx-auto mb-12 max-w-2xl text-center lg:mb-16">
        <h2 className="font-iransans text-2xl font-black text-white sm:text-3xl lg:text-5xl">
          {BRANDING_CASE_STUDIES_INTRO.title}
        </h2>
        <p className="mt-4 text-base leading-relaxed text-content-gray sm:text-lg">
          {BRANDING_CASE_STUDIES_INTRO.subtitle}
        </p>
      </div>
