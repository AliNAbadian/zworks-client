...
import { BRANDING_CTA } from "@/features/branding/branding-data";

const BrandingCtaSection = () => {
  return (
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center gap-6 px-6 py-16 text-center sm:gap-8 sm:px-10">
          ...
          <div className="flex w-full max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:justify-center">
            <Button
              ...
              size="lg"
            >
              <Link href={BRANDING_CTA.primaryCta.href}>
                {BRANDING_CTA.primaryCta.label}
              </Link>
            </Button>
            <Button
              asChild
              ...
              variant="outline"
            >
              <Link href={BRANDING_CTA.secondaryCta.href}>
                {BRANDING_CTA.secondaryCta.label}
              </Link>
            </Button>
          </div>
...
export default BrandingCtaSection;
