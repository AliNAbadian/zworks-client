...
import {
  BRANDING_SERVICES_INTRO,
  serviceItems,
} from "@/features/branding/branding-data";
import type { ServiceIcon } from "@/features/branding/branding-model";
import { cn } from "@/lib/utils";

const serviceIcons: Record<ServiceIcon, typeof Compass> = {
  "brand-strategy": Compass,
  "logo-design": PenTool,
  "visual-identity": Fingerprint,
  typography: Type,
  "color-systems": Droplets,
