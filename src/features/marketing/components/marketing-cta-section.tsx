...
import { MARKETING_CTA } from "@/features/marketing/marketing-data";
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center gap-6 px-6 py-16 text-center sm:gap-8 sm:px-10">
          ...
          <div className="flex w-full max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:justify-center">
            <Button
              ...
              size="lg"
            >
              <Link href={MARKETING_CTA.primaryCta.href}>
                {MARKETING_CTA.primaryCta.label}
              </Link>
            </Button>
            <Button
              asChild
              ...
              variant="outline"
            >
              <Link href={MARKETING_CTA.secondaryCta.href}>
                {MARKETING_CTA.secondaryCta.label}
              </Link>
            </Button>
          </div>
