...
import {
  MARKETING_BENEFITS_INTRO,
  benefitItems,
} from "@/features/marketing/marketing-data";
import type { BenefitIcon } from "@/features/marketing/marketing-model";
