...
import {
  MARKETING_SERVICES_INTRO,
  serviceItems,
} from "@/features/marketing/marketing-data";
import type { ServiceIcon } from "@/features/marketing/marketing-model";
import { cn } from "@/lib/utils";

const serviceIcons: Record<ServiceIcon, typeof Megaphone> = {
