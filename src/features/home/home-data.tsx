...
export const HOME_POSITIVITIES_INTRO =
  "مارس شریک دیجیتال شماست؛ از طراحی UI/UX و توسعه وب با React و Next.js تا اپلیکیشن موبایل، سئو، برندسازی، دیجیتال مارکتینگ، پشتیبانی و زیرساخت ابری — همه‌چیز برای رشد محصول و کسب‌وکار شما." as const;
...
export const HOME_PROJECTS_INTRO =
  "نمونه‌ای از پروژه‌های واقعی در حوزه وب، موبایل و رشد دیجیتال که با تیم مارس طراحی و اجرا شده‌اند." as const;
...
export const HOME_CTA = {
  ...
  description:
    "از مشاوره رایگان تا اجرای کامل؛ تیم مارس در کنار شماست تا بهترین راهکار دیجیتال را برای کسب‌وکارتان پیاده‌سازی کند.",
