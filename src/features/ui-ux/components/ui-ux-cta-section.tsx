...
import { UI_UX_CTA } from "@/features/ui-ux/ui-ux-data";

const UiUxCtaSection = () => {
  return (
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center gap-6 px-6 py-16 text-center sm:gap-8 sm:px-10">
          ...
          <div className="flex w-full max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:justify-center">
            <Button
              ...
              size="lg"
            >
              <Link href={UI_UX_CTA.primaryCta.href}>
                {UI_UX_CTA.primaryCta.label}
              </Link>
            </Button>
            <Button
              asChild
              ...
              variant="outline"
            >
              <Link href={UI_UX_CTA.secondaryCta.href}>
                {UI_UX_CTA.secondaryCta.label}
              </Link>
            </Button>
          </div>
