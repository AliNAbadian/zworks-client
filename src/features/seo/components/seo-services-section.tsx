...
import type { ServiceIcon } from "@/features/seo/seo-model";
import { cn } from "@/lib/utils";

const serviceIcons: Record<ServiceIcon, typeof Search> = {
  technical: Settings,
  keyword: Search,
  content: FileText,
  "on-page": LayoutTemplate,
  "off-page": Link2,
  local: MapPin,
};
