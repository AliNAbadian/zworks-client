...
import {
  MOBILE_APPS_SERVICES_INTRO,
  serviceItems,
} from "@/features/mobile-apps/mobile-apps-data";
import type { ServiceIcon } from "@/features/mobile-apps/mobile-apps-model";
import { cn } from "@/lib/utils";

const serviceIcons: Record<ServiceIcon, typeof Smartphone> = {
  android: Smartphone,
...
export default MobileAppsServicesSection;
