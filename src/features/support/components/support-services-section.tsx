...
import {
  SUPPORT_SERVICES_INTRO,
  serviceItems,
} from "@/features/support/support-data";
import type { ServiceIcon } from "@/features/support/support-model";
import { cn } from "@/lib/utils";

const serviceIcons: Record<ServiceIcon, typeof Bug> = {
  "bug-fix": Bug,
  monitoring: Activity,
  backup: Database,
  speed: Gauge,
