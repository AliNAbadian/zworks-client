...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <div className="cursor-pointer hover:bg-white/10 dura bg-white/5 flex flex-row items-center justify-center p-2 rounded-full shrink-0 translate-y-0.5 transition-all duration-200">
